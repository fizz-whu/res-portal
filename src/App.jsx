        ...
        <div className="w-full max-w-2xl text-center">
          <div className="bg-white dark:bg-background-dark p-8 sm:p-12 rounded-xl shadow-soft-lg">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a className="w-full sm:w-auto flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-white bg-primary hover:bg-primary/90 transition-colors duration-300" href="#">
                Register Restaurant
              </a>
